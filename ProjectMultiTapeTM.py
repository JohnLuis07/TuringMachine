...
class MultiTapeTuringMachine:
    def __init__(self, states, symbols, input_string1, input_string2, blank_symbol='B'):
        ...
        self.tape1 = [blank_symbol] * (len(input_string1) + 1) + list(input_string1) + [blank_symbol]
        self.tape2 = [blank_symbol] * (len(input_string2) + 1) + list(input_string2) + [blank_symbol] 
        self.tape3 = [blank_symbol] * (len(input_string1) + 1) + [blank_symbol] * (len(input_string2) + 1) + [blank_symbol]
    ...
    def transition(self):
        ...
        transitions = self.current_state.delta(input_symbol1, input_symbol2, input_symbol3)
